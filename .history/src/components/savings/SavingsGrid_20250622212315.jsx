...
import pb18Small from '../../assets/PB 18 Small.png';
import sl22Small from '../../assets/SL 22 Small.png';
import iphonw from '../../assets/iphonw.avif';
import iphone14 from '../../assets/iPhone 14.avif';
import iphone12 from '../../assets/iphone12.avif';
import iphone14_1 from '../../assets/iPhone 14 - 1.png';
    ...
    <div className="savings-grid">
      <div className="grid-item item-1">
        <div className="item-content">
          ...
          <div className="item-overlay">
            <img src={pb18Small} alt="Automated Savings Image" />
      ...
      <div className="grid-item item-2">
        <div className="item-content">
          ...
          <div className="item-overlay">
            <img src={sl22Small} alt="Fixed Savings Image" />
            <div className="overlay-text">
              <h1>Fixed Savings</h1>
              <p>Lock money away for a fixed duration without having access to it until maturity. It's like having a custom fixed deposit.</p>
              <h5>Safelock</h5>
      ...
      <div className="grid-item item-3">
        <div className="item-content">
          ...
          <div className="item-overlay">
            <img src={iphonw} alt="Goal-Oriented Savings Image" />
            <div className="overlay-text">
              <h1>Goal-Oriented Savings</h1>
              <p>Reach all your savings goals faster. Save towards multiple goals on your own or with a group.</p>
              <h5>Target Savings</h5>
      ...
      <div className="grid-item item-6">
        <div className="item-content">
          ...
          <div className="item-overlay">
            <img src={iphone14_1} alt="HouseMoney Image" />
            <div className="overlay-text">
              <h1>HouseMoney</h1>
              <p>Plan for your rent and household expenses</p>
              <h5>HouseMoney</h5>
